...
public class SyncRequest {
    ...
    public static class DietRecordData {
        ...
        private Long updatedAt;
        private Long agentActionId;  // Agent创建的记录关联的actionId
        private String recordKey;     // 记录级别的幂等键
        ...
        public Long getUpdatedAt() { return updatedAt; }
        public void setUpdatedAt(Long updatedAt) { this.updatedAt = updatedAt; }
        public Long getAgentActionId() { return agentActionId; }
        public void setAgentActionId(Long agentActionId) { this.agentActionId = agentActionId; }
    ...
    public static class TrainingPlanData {
        ...
        private Long updatedAt;
        private Long agentActionId;  // F0新增：Agent创建的计划关联的actionId
